...
export default function Register() {
  return (
    <>
      ...
      <header className="z-20 absolute flex min-h-10  w-full top-0 md:m-0 px-4 md:px-6 py-6 md:py-3  items-center justify-between bg-[#095140] ">
        <div>
          <Link
            href={"/"}
      ...
      <div className=" max-w-screen-xl h-screen px-8  md:px-16 lg:px-16 xl:px-32 py-16 bg-[#f8f3e7] text-gray-900 ">
        <div className="flex mx-auto w-full py-12">
          <div className="flex mx-auto w-full flex-col space-y-4 ">
            <div className="flex flex-col space-y-2">
              <h3 className="font-semibold text-2xl text-[#095140]">Create an account</h3>
              <span>
              Create an account to join your organisation
                <br />
            ...
            <div className="">
              <span className="text-lg text-[#095140] font-semibold">
                First name
              </span>
              <input
            ...
            <div className="pt-4">
              <button className="text-md font-bold tracking-wide bg-[#073d30] hover:opacity-80 text-white py-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                Register
              </button>
            </div>
          </div>
      ...
      <footer className="absolute z-20 w-full bottom-5">
          <div className="flex flex-col space-y-2">
