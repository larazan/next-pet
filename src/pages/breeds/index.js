  ...
  return (
    <>
      ...
      <PopularBreed />
        ...
        <div className="h-max mx-auto w-full lg:w-1/2 flex flex-col space-y-3 px-3 md:px-6 lg:px-0 py-0 md:py-4 justify-center2 items-center2 bg-[#f8f3e7]">
            <div>
...
<Link href={""} className='flex justify-center items-center mb-1.5 w-8 h-8 hover:bg-blue-800 px-2 py-1 border-2 text-gray-900 hover:text-white border-gray-900'>
        ...
        <div className="h-max mx-auto w-full lg:w-1/2 flex flex-col space-y-3 px-3 md:px-6 lg:px-0 py-0 md:pt-4 pb-20  justify-center2 items-center2 bg-[#f8f3e7]">
            <div className='py-2'>
