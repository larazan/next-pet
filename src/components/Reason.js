    ...
    <>
      <div className="flex relative z-10 items-center overflow-hidden bg-[#f8f3e7]">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8 mb-8 mx-auto py-6 w-full px-3 md:px-0 md:w-10/12 ">
          <div className="relative rounded-lg flex justify-center text-center flex-col space-y-2 px-0 py-16 bg-[#ff8dbd]">
            ...
            <div className="flex flex-col space-y-2 px-4">
              ...
              <span className="">Engage, attract & retain talent</span>
              <Link
                href={""}
          ...
          <div className="relative rounded-lg flex justify-center text-center flex-col space-y-2 px-0 py-16 bg-[#7ce993]">
            <div className="absolute w-full -top-8">
              <div className="flex justify-center items-center">
            ...
            <div className="flex flex-col space-y-2 px-4">
              ...
              <span className="">Create impact & measure social value</span>
              <Link
                href={""}
                className="font-semibold text-[18px] underline underline-offset-4"
              >
          ...
          <div className="relative rounded-lg flex justify-center text-center flex-col space-y-2 px-0 py-16 bg-[#30ba99]">
            <div className="absolute w-full -top-8">
              <div className="flex justify-center items-center">
            ...
            <div className="flex flex-col space-y-2 px-4">
              ...
              <span className="">Track CO2e reductions & plant trees</span>
              <Link
                href={""}
                className="font-semibold text-[18px] underline underline-offset-4"
              >
          ...
          <div className="relative rounded-lg flex justify-center text-center flex-col space-y-2 px-0 py-16 bg-[#fbd718]">
            <div className="absolute w-full -top-8">
              <div className="flex justify-center items-center">
