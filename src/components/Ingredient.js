        ...
        <Tabs>
            ...
            <div className="flex w-full py-4">
              ...
              <div className="w-1/3 flex flex-col space-y-2">
                <div className="text-center">
                  <h3 className="text-lg font-semibold">Salmon</h3>
                  <p className="text-lg">92%</p>
                </div>
                <div className="text-center">
                  <h3 className="text-lg font-semibold">Bone Broth</h3>
                  <p className="text-lg">3%</p>
                </div>
                <div className="text-center">
                  <h3 className="text-lg font-semibold">Natural Preservatives</h3>
          ...
          <Tab label="Calorie Content">
            <div className="py-4 w-full">
              <div className="w-1/2">
                <h3 className="text-lg font-bold">Calorie Content</h3>
          ...
          <Tab label="Guaranteed Analysis">
            <div className="flex py-4 w-full">
              ...
              <div className="w-1/2 flex flex-col space-y-3">
                ...
                <div>
                  <h3 className="text-lg font-medium">Moisture</h3>
